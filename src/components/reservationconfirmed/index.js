...
const ReservationConfirmed = function (){
  ...
  <div className="bodyComponent">
     ...
     <div className="contentMessaje">
      ...
      <p className="messaje">
      En hasta 5 minutos, recibirás un correo electrónico en /email de usuario / con todos los detalles de tu reservación.
     ...
     <section className = "contentPedido">
      ...
      <div className = "itemPedido">
        ...
        <div className="subitemPedido"> <h2>RESERVA</h2> <p className="numeroR"> #6343854384</p></div>
          
       <p>Hecho el 10/10/2022 a las 11:35 hs para el 12/10/2022 a las 13:00 hs</p>
   
    
      </div>

      <div className="itemPedidoButton">
        <button className="editReservationBtn">{editIcon}editar reserva</button>
        <button className="cancelReservationBtn"> {cancelIcon} cancelar reserva</button>
      </div>
