...
const CreateOperator = function () {
  ...
  return (
    <>
      {showPopUpConfirm && <PopupConfirm onChange={manejarCambio} message = {"<h2>¿Estás seguro que reemplazar al anterior operador?</h2><br/>Su asociación a la sucursal será removida. Contacta al anterior operador de ser necesario"}/>}
