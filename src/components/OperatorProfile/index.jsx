...
return(
  <div className="bodyContent">
    ...
    <form action="" className="contentOprPerfil" onSubmit={handleUpdateProfile}>
        
      <div> <h1> MIS DATOS</h1> </div>

      <div className="item-O-P">
          <label htmlFor="nombre">Nombre</label>
          <input type="text" name="name" id="nombre"  defaultValue={date.fullname}/>
      </div>

      <div className="item-O-P"> 
          <label htmlFor="email">Correo electrónico</label>
          <input type="email" name="email" id="email" defaultValue={date.email} readOnly/>
      </div>
      ...
      <div className="itemFila-O-P">
        ...
        <div className="subItemFila">
          ...
          <input type="text" name="Dni" id="dni" defaultValue={date.dni} readOnly/>
        </div>

        <div  className="subItemFilaSelect">
       
          <label htmlFor="sucursal">Sucursal</label>
         <select name="sucursal" id="sucursal" className="select-style" disabled>
           <option selected>/sucursal a la que pertenece valor por default/</option> 
